...
LAYOUTS = {
    ...
    'compact': [
        ('shelf_A1', -3.6, 1.75, 1.4, 0.5),
        ('shelf_A2', 0.0, 1.75, 1.4, 0.5),
        ('shelf_A3', 3.6, 1.75, 1.4, 0.5),
        ('shelf_B1', -3.6, -1.75, 1.4, 0.5),
        ('shelf_B2', 0.0, -1.75, 1.4, 0.5),
        ('shelf_B3', 3.6, -1.75, 1.4, 0.5),
    ],
    'cross_traffic': [
        ('shelf_A1', -3.2, -2.3, 0.5, 1.2),
        ('shelf_A2', -3.2, 0.0, 0.5, 1.2),
        ('shelf_A3', -3.2, 2.3, 0.5, 1.2),
        ('shelf_B1', 3.2, -2.3, 0.5, 1.2),
        ('shelf_B2', 3.2, 0.0, 0.5, 1.2),
        ('shelf_B3', 3.2, 2.3, 0.5, 1.2),
    ],
}
